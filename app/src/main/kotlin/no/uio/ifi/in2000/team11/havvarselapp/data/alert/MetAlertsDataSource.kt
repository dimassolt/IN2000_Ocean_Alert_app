    ...
    private suspend fun fetchMetAlerts(url: String): List<MetAlert> {
        try {
            ...
            for (i in 0 until features.length()) {
                ...
                // lagre info om dette farevarselet bare hvis det er av type "marine"
                val type = alert.getJSONObject("properties").optString("geographicDomain")
                if (!type.equals("marine")) { continue }
